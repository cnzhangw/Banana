    ...
    class _Pinyin
    {
        ...
        public static string GetInitials(string input)
        {
         ...
         "鳕鳗鳘鳙鳜鳝鳟鳢靼鞅鞑鞒鞔鞯鞫鞣鞲鞴骱骰骷鹘骶骺骼髁髀髅髂髋髌髑魅魃魇魉魈魍魑飨餍餮饕饔髟髡髦髯髫髻髭髹鬈鬏鬓鬟鬣麽麾縻麂麇麈麋麒鏖麝麟黛黜黝黠黟黢黩黧黥黪黯鼢鼬鼯鼹鼷鼽鼾齄";
            ...
            {
                array = System.Text.Encoding.Default.GetBytes(input[i].ToString());
                ...
                else if (array[0] >= 176 && array[0] <= 215)
                {
                    ...
                    if (input[i].ToString().CompareTo("匝") >= 0)
                        return_py += "z";
                    else if (input[i].ToString().CompareTo("压") >= 0)
                        return_py += "y";
                    else if (input[i].ToString().CompareTo("昔") >= 0)
                        return_py += "x";
                    else if (input[i].ToString().CompareTo("哇") >= 0)
                        return_py += "w";
                    else if (input[i].ToString().CompareTo("塌") >= 0)
                        return_py += "t";
                    else if (input[i].ToString().CompareTo("撒") >= 0)
                        return_py += "s";
                    else if (input[i].ToString().CompareTo("然") >= 0)
                        return_py += "r";
                    else if (input[i].ToString().CompareTo("期") >= 0)
                        return_py += "q";
                    else if (input[i].ToString().CompareTo("啪") >= 0)
                        return_py += "p";
                    else if (input[i].ToString().CompareTo("哦") >= 0)
                        return_py += "o";
                    else if (input[i].ToString().CompareTo("拿") >= 0)
                        return_py += "n";
                    else if (input[i].ToString().CompareTo("妈") >= 0)
                        return_py += "m";
                    else if (input[i].ToString().CompareTo("垃") >= 0)
                        return_py += "l";
                    else if (input[i].ToString().CompareTo("喀") >= 0)
                        return_py += "k";
                    else if (input[i].ToString().CompareTo("击") >= 0)
                        return_py += "j";
                    else if (input[i].ToString().CompareTo("哈") >= 0)
                        return_py += "h";
                    else if (input[i].ToString().CompareTo("噶") >= 0)
                        return_py += "g";
                    else if (input[i].ToString().CompareTo("发") >= 0)
                        return_py += "f";
                    else if (input[i].ToString().CompareTo("蛾") >= 0)
                        return_py += "e";
                    else if (input[i].ToString().CompareTo("搭") >= 0)
                        return_py += "d";
                    else if (input[i].ToString().CompareTo("擦") >= 0)
                        return_py += "c";
                    else if (input[i].ToString().CompareTo("芭") >= 0)
                        return_py += "b";
                    else if (input[i].ToString().CompareTo("啊") >= 0)
                        return_py += "a";
                }
                //二级汉字
                else if (array[0] >= 215)
                {
                    return_py += ls_second_eng.Substring(ls_second_ch.IndexOf(input[i].ToString(), 0), 1);
                }
            }
        ...
        /// <param name="input">汉字</param>
        /// <returns>首字母</returns>
        public static string GetInitialsByEncoding(string input)
        {
            int i = 0;
            ushort key = 0;
