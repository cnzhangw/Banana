...
namespace Banana.Core.Interface
{
    public interface IQuery
    {
        ...
        ///     object.
        /// </remarks>
        PagingResult<T> Page<T>(long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs);
        ...
        /// </remarks>
        PagingResult<T> Page<T>(long page, long itemsPerPage, string sql, params object[] args);
        ...
        ///     total number of records in the result set.
        /// </remarks>
        PagingResult<T> Page<T>(long page, long itemsPerPage, Sql sql);
        ...
        ///     object.
        /// </remarks>
        PagingResult<T> Page<T>(long page, long itemsPerPage, Sql sqlCount, Sql sqlPage);
