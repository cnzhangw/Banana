...
namespace Banana.Core.Poco
{
    ...
    public class Database : IDisposable
    {
        ...
        Regex rxSelect = new Regex(@"\A\s*(SELECT|EXECUTE|EXEC|CALL)\s", RegexOptions.Compiled | RegexOptions.Singleline | RegexOptions.IgnoreCase | RegexOptions.Multiline);
    ...
    public class Sql
    {
        ...
        private void Build(StringBuilder sb, List<object> args, Sql lhs)
        {
            if (!String.IsNullOrEmpty(_sql))
            {
                ...
                var sql = Banana.Core.Poco.Database.ProcessParams(_sql, _args, args);
